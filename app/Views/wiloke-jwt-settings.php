...
<?php
$actionURL = is_network_admin() ? network_admin_url( 'admin.php?page=' . $this->slug ) :
...
<form method="POST" action="<?php echo esc_url( $actionURL ); ?>">
    <table class="form-table">
        <thead>
        <tr>
            <th>Generate Access Token and Refresh Token</th>
        </tr>
        </thead>
    </table>
    <input type="hidden" name="route" value="generate_tokens">
